...
function guessNumber(){
	var result = prompt("Введите число (-1 - закончить игру), " + "Выша попытка № " + attempts, 0);
	...
	while(gameIsRunning){
		...
		// проверяем число
			...
			if(answer[0]){
				...
				// следующий ход
				result = prompt("Быки: " + answer[1] + " Коровы: " + answer[2] + " Введите число (-1 - закончить игру), " + "Выша попытка № " + attempts, 0);
			}
		}
	}
}
