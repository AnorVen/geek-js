...
function splitIt(){
  ...
  if(b.length > 3){
    ...
    console.log("числа: " + b[0])
  }
  else if(b.length == 2){
    console.log("десятки: " + b[0] + ", числа: " + b[1])
  }
  else{
    console.log("Сотни: " + b[0] + ", десятки: " + b[1] + ", числа: " + b[2])
  }
  ...
  while(gameIsRunning){
    ...
    // проверяем число
      ...
      if(answer[0]){
        ...
        // следующий ход
      result = prompt("Быки: " + answer[1] + " Коровы: " + answer[2] + " Введите число (-1 - закончить игру), " + "Выша попытка № " + (attempts +1 ), 0); //вывод добавлен сюда
      }
    }
  }
}
